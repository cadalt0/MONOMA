...
/**
 * @title EthereumSepoliaWalletFactory
 ...
 */
contract EthereumSepoliaWalletFactory is Ownable {
    ...
    address public constant USDC = 0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238; // Ethereum Sepolia
     ...
     * @param destinationDomain Target chain domain ID (e.g., Base = 6, Arbitrum = 3)
    ...
    function createBurnWallet(
        ...
        require(destinationDomain == 3, "destinationDomain must be 3");
